 ...
 * @LastEditTime: 2021-06-24 18:15:25
 * @Description: 模态框二次封装
 * @LastEditors: Mr.Mao
...
<template>
  ...
  >
    ...
    <i
      v-if="closable"
      class="nr-close text-lg cursor-pointer align-middle px-5 absolute right-24 top-20"
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup: (props, { emit }) => {
      ...
      return { showModal, onClone, onConfirm, props }
    }
  })
</script>
<style lang="scss">
