 ...
 * @LastEditTime: 2021-06-26 14:50:00
 * @Description: 
 * @LastEditors: Mr.Mao
  ...
  >
    <div class="flex justify-between mb-28">
      <div class="flex items-center">
        ...
        <div class="text-grey-darkmin text-xs">图片大小不要超过10M ，支持图片格式jpg/png/gif</div>
      </div>
...
<script lang="ts" setup>
  ...
  const onClickUpload = async () => {
    ...
    const isAccordSize = files.some((v) => v.size / 1000 / 1024 < 10)
