 ...
 * @LastEditTime: 2021-06-15 16:14:14
 * @Description: 
 * @LastEditors: Mr.Mao
      ...
      >
        ...
        <template v-else-if="paymentConfig?.type === 'qrcode'">
          ...
          <div class="flex flex-col">
            ...
            <div class="text-grey-darkest text-xs mt-5">
        ...
        <template v-else>
          ...
          <div class="flex flex-col">
            <div class="text-xs">客服电话：15570131212</div>
            <div class="text-grey-darkest text-xs mt-10">
...
<script lang="ts" setup>
  ...
  import { reqPlaceThemeOrder } from '@/api/theme'
  ...
  const getPaymentConfig = async () => {
    const { data } = await reqPlaceThemeOrder({
      ...props.params,
