 ...
 * @LastEditTime: 2021-06-26 17:10:48
...
// 客服数据
export const RECEVE_CUSTOMER = 'receve_customer'

//版权信息
export const RECEVE_COPY_INFO = 'receve_copy_info'
export const DELETE_COPY_INFO = 'delete_copy_info'

//
export const MODIFY_USER_AVATAR = 'modify_user_avatar'
