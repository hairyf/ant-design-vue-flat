 ...
 * @LastEditTime: 2021-04-23 12:05:50
 * @Description: 商品展播 操作页面
 * @LastEditors: Zhilong
 * @autograph: ⚠ warning!  ⚠ warning!  ⚠ warning!   ⚠野生的页面出现了!!
-->
<template>
  <edit-header icon="ad-commodity-exhibition" title="商品展播" />
  <edit-card-form title="组件风格">
    ...
    <el-form-item label="背景图">
      <image-item v-model="option.componentStyle.backgroundImage" />
    </el-form-item>
  </edit-card-form>
  <!-- 添加商品 -->
  ...
  <edit-card-form title="整体样式">
    <color-group v-model="option.contentStyle.color" reset>
      <el-form-item label="主标题">
        <el-input
          class="oe-flex"
          v-model="option.contentStyle.title"
          maxlength="10"
          show-word-limit
        />
      </el-form-item>
      ...
      <el-form-item label="副标题">
        <el-input
          class="oe-flex"
          v-model="option.contentStyle.subTitle"
          maxlength="10"
          show-word-limit
        />
      </el-form-item>
      ...
      <el-form-item label="链接">
        <link-item v-model="option.contentStyle.link" />
      </el-form-item>
    </color-group>
  </edit-card-form>
  <!-- 颜色样式 -->
  <edit-card-form title="组件样式">
    ...
    <color-group v-model="option.colorStyle.color" class="oe-m-b-20" reset>
      ...
      <color-input keyword="text" label="价格颜色" />
      <color-input keyword="btn" label="按钮颜色" />
    </color-group>
  </edit-card-form>
