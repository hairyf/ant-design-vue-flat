(function (global, factory) {
  ...
  const _withId$7 = /* @__PURE__ */ vue.withScopeId("data-v-4090dad8");
  const __default__$F = vue.defineComponent({ name: "CalButton" });
  ...
  const __default__$E = vue.defineComponent({ name: "CalGlobalStyle" });
  ...
  const __default__$D = vue.defineComponent({ name: "CalProvide" });
  ...
  const _hoisted_1$d = { class: "cal-config-provider" };
  vue.popScopeId();
  const __default__$C = vue.defineComponent({ name: "CalConfigProvider" });
  ...
  const _hoisted_1$c = { class: "cal-menu transition-all duration-200" };
  const __default__$B = vue.defineComponent({ name: "CalMenu" });
  ...
  const _withId$6 = /* @__PURE__ */ vue.withScopeId("data-v-9a2e6faa");
  vue.pushScopeId("data-v-9a2e6faa");
  const _hoisted_1$b = { class: "cal-menu-item__prefix" };
  const _hoisted_2$9 = {
    key: 0,
    class: "cal-menu-item__content"
  };
  vue.popScopeId();
  const __default__$A = vue.defineComponent({ name: "CalMenuItem" });
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createBlock("li", {
          ...
          vue.createVNode("span", _hoisted_1$b, [
          ...
          vue.createVNode(vue.Transition, {
            ...
            default: _withId$6(() => [
              !vue.unref(collapse) ? (vue.openBlock(), vue.createBlock("span", _hoisted_2$9, [
                vue.renderSlot(_ctx.$slots, "default")
  ...
  const __default__$z = vue.defineComponent({ name: "CalLayout" });
  ...
  const __default__$y = vue.defineComponent({ name: "CalLayoutContent" });
  ...
  const __default__$x = vue.defineComponent({ name: "CalLayoutSider" });
  ...
  const __default__$w = vue.defineComponent({ name: "CalBackground" });
  ...
  const __default__$v = vue.defineComponent({ name: "CalEllipsis" });
  ...
  const __default__$u = vue.defineComponent({ name: "CalSpace" });
  ...
  const _hoisted_1$a = { class: "cal-grid__container" };
  const _hoisted_2$8 = { class: "cal-grid__view" };
  const __default__$t = vue.defineComponent({ name: "CalGrid" });
  ...
  const __default__$s = vue.defineComponent({ name: "CalInput" });
    ...
    setup(__props, { emit }) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createBlock(vue.unref(antd.Input), vue.mergeProps({ class: "cal-input" }, props, {
          ...
          suffix: vue.withCtx(() => [
            vue.unref(slots)["suffix"] ? vue.renderSlot(_ctx.$slots, "suffix", { key: 0 }) : __props.showCount ? (vue.openBlock(), vue.createBlock("div", _hoisted_1$9, [
  ...
  const _hoisted_1$8 = /* @__PURE__ */ vue.createVNode("div", {
    class: "text-center text-sm text-gray-darkmin my-auto",
    style: { "min-width": "32px" }
  }, "-", -1);
  const __default__$r = vue.defineComponent({ name: "CalInputSection" });
  ...
  const __default__$q = vue.defineComponent({ name: "CalInputPassword" });
  ...
  const __default__$p = vue.defineComponent({ name: "CalInputDate" });
  ...
  const __default__$o = vue.defineComponent({ name: "CalInputNumber" });
    ...
    setup(__props, { emit }) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createBlock(vue.unref(antd.InputNumber), vue.mergeProps({
          ...
          suffix: vue.withCtx(() => [
            vue.unref(slots)["suffix"] ? vue.renderSlot(_ctx.$slots, "suffix", { key: 0 }) : __props.showCount ? (vue.openBlock(), vue.createBlock("div", _hoisted_1$7, [
              vue.createVNode("span", null, vue.toDisplayString(currentFontNumber.value), 1),
              __props.maxLength ? (vue.openBlock(), vue.createBlock("span", _hoisted_2$6, "/" + vue.toDisplayString(__props.maxLength), 1)) : vue.createCommentVNode("v-if", true)
            ])) : vue.createCommentVNode("v-if", true)
          ]),
          default: vue.withCtx(() => [
            vue.renderSlot(_ctx.$slots, "default")
  ...
  const __default__$n = vue.defineComponent({ name: "CalInputSearch" });
  ...
  const __default__$m = vue.defineComponent({ name: "CalIcon" });
  ...
  var script = vue.defineComponent({
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createBlock(_component_a_tag, null, {
          default: vue.withCtx(() => [
            vue.renderSlot(_ctx.$slots, "default")
          ]),
          _: 3
