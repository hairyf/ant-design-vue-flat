<!--
 * @Author: Zhilong
 * @Date: 2021-04-08 19:22:46
 * @LastEditTime: 2021-05-13 18:08:52
 * @Description: 轮播搜索操作区
 * @LastEditors: Zhilong
 * @autograph: ⚠ warning!  ⚠ warning!  ⚠ warning!   ⚠野生的页面出现了!!
-->
<template>
  <edit-header title="轮播搜索" icon="ad-carousel-search" />
  <!-- 组件风格 -->
  ...
  <edit-card-form title="搜索设置">
    ...
    <el-form-item label="透明度">
      <slider-input v-model="option.searchSetting.opacity" :max="100" tips="%" />
    </el-form-item>
  </edit-card-form>
  <!-- 轮播图设置 -->
  ...
  <edit-card-form title="边距设置">
    <slider-group v-model="option.padding">
      ...
      <slider-input keyword="leftRight" label="左右边距" :max="50" tips="px" />
  ...
  <edit-card-form title="高度设置">
    <el-form-item label="高度">
      <slider-input v-model="option.heightSetting.height" :min="100" :max="1000" tips="px" />
    </el-form-item>
  </edit-card-form>
</template>
