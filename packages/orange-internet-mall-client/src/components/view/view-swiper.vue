<!--
 * @Author: Pan.Yu.Lin
 * @Date: 2021-04-26 17:53:48
 * @LastEditTime: 2021-05-11 09:36:17
 * @Description: 
 * @LastEditors: Zhilong
-->
<template>
      ...
      >
        <view
          ...
          :style="{
            ...
            margin: effect3d && uCurrent != index ? `0 ${imageMargin}rpx` : 0,
          }"
        >
          <image
 ...
 * @property {Number} image-margin 轮播图3D的间距，单位rpx（默认20）
