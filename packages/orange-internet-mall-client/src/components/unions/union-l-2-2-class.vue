 ...
 * @LastEditTime: 2021-05-13 19:35:32
 * @Description: 商城
    ...
    <div class="shop-mall" v-if="list">
      ...
      <div class="shop-menu-content" :style="{ height: menuContentHeight }">
        ...
        <scroll-view scroll-y class="right-content" v-if="list">
          ...
          <div class="items" v-if="levelTwoMenuList.length > 0">
            <div
              class="item"
            ...
            <div style="width: 96rpx; margin: 0 84rpx 20rpx 0"></div>
            <div style="width: 96rpx; margin: 0 0 20rpx 0"></div>
          </div>
          <div class="u-flex" v-else>
            <u-empty text="当前暂无商品" mode="list" />
          </div>
        </scroll-view>
      </div>
    </div>
