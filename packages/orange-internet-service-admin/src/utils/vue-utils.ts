 ...
 * @LastEditTime: 2021-06-28 19:33:30
 * @Description:
...
export const outputRoutes = (routes: RouteRecordRaw[]) => {
  ...
  const blob = new Blob([JSON.stringify(recursion(routes), null, '\t')])
  alink.download = 'routes-surface.json'
...
// 导出方法
export const exportReport = (data: Blob, name: string) => {
